            ...
            <div class="container">
                ...
                "
                            ...
                            <a class="nav-link list-group-item list-group-action" id="v-pills-pengiriman-tab"
                                data-toggle="pill" href="#v-pills-pengiriman" role="tab"
                                aria-controls="v-pills-pengiriman" aria-selected="false">Metode Pembayaran</a>
                            <a class="nav-link list-group-item list-group-action" id="v-pills-akun-tab" data-toggle="pill"
                                href="#v-pills-akun" role="tab" aria-controls="v-pills-akun"
                            ...
                            <a class="nav-link list-group-item list-group-action" id="v-pills-transaksi-tab"
                                data-toggle="pill" href="#v-pills-transaksi" role="tab"
                                aria-controls="v-pills-transaksi" aria-selected="false">Transaksi</a>
                            <a class="nav-link list-group-item list-group-action" id="v-pills-dana-tab" data-toggle="pill"
                                href="#v-pills-dana" role="tab" aria-controls="v-pills-dana"
                                aria-selected="false">Pencairan
                                Dana</a>
                            <a class="nav-link list-group-item list-group-action" id="v-pills-gantirugi-tab"
                                data-toggle="pill" href="#v-pills-gantirugi" role="tab"
                                aria-controls="v-pills-gantirugi" aria-selected="false">Ganti Rugi</a>
